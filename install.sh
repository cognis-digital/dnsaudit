#!/usr/bin/env sh
# Universal installer for dnsaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dnsaudit.git"
echo "Installing dnsaudit ..."
